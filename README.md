...
[[![Release](https://img.shields.io/github/v/release/fl4te/jk2_skybox_creator?label=latest%20release)](https://github.com/fl4te/jk2_skybox_creator/releases) &nbsp;•&nbsp; [![Build Status](https://github.com/fl4te/jk2_skybox_creator/actions/workflows/build_and_release.yml/badge.svg?branch=main)](https://github.com/fl4te/jk2_skybox_creator/actions/workflows/build_and_release.yml) &nbsp;•&nbsp; [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

**A tool for converting equirectangular panoramas into skybox textures for Jedi Knight 2.**

![JK2 Skybox Creator Screenshot](https://i.ibb.co/JFKZBZ3v/jk2-skybox-creator.png)

---

## Features

- **Panorama to Skybox Conversion**: Convert equirectangular (360°) images into 6 cube faces for JK2 skyboxes.
- **Customizable Output**: Adjust resolution (512, 1024, 2048, 4096), prefix, and orientation (yaw, pitch).
- **Engine-Specific Tweaks**: Flip top/bottom faces and rotate them to match JK2 standards.
...
Flip UP/DN: Toggle to match JK2’s coordinate system.
